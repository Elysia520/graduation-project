...
public class UpdateComponent extends JPanel implements ActionListener {
	...
	public UpdateComponent() {
		...
		tf_old_classname.setFont(new Font("����", Font.BOLD, 35));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == back) {
			...
			if(!TableOperate.search_bookstate(old_classname, old_number).equals("null")) {
				...
				//�������鼮��Ϣ
				TableOperate.insertComponent(number, classnumber, name, classname, price, state, "1");
				...
				JOptionPane.showMessageDialog(null, "�ɹ�", "������Ϣ�ɹ�", JOptionPane.OK_CANCEL_OPTION);
			}else {
				JOptionPane.showMessageDialog(null, "������Ϣ����", "������Ϣʧ��", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
}
